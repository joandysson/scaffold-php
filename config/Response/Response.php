 ...
 * @method void send(?string $content = null, int|HttpStatus|null $status = null)
 ...
 * @method static void send(?string $content = null, int|HttpStatus|null $status = null)
...
class Response
{
    ...
    protected function send(?string $content = null, int|HttpStatus|null $status = null): void
    {
        if ($content !== null) {
